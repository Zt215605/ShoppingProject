<template>
  <div class="trade-container">
    ...
    <div class="sub clearFix">
      <!-- <router-link class="subBtn" to="/pay" @click="sumbit">提交订单</router-link> -->
...
// import {  } from "@/api";  假如说接口很多不使用一个一个引入可以在main.js中借助vue原型实现
export default {
  name: "Trade",
  data() {
    return {
  ...
  methods: {
    ...
    async submit() {
      ...
      let result;
      try {
        result = await this.$API.reqSubmitOrder(tradeNo, data);
        console.log(result);
        if(result.code==200){
          // 提交订单成功时存一下订单号
